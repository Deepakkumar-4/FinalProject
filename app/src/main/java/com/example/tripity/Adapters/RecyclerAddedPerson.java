...
public class RecyclerAddedPerson extends RecyclerView.Adapter<RecyclerAddedPerson.AddedPersonModelViewHolder>{
    ...
    @NonNull
    @Override
    public AddedPersonModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.added_person_layout, parent, false);
        AddedPersonModelViewHolder viewHolder = new AddedPersonModelViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AddedPersonModelViewHolder holder, @SuppressLint("RecyclerView") int position) {
