        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(!personList.isEmpty()){
                   for(AddedPersonModel ele : personList ){
                       if(ele.getType()== "Child"){
                           total_amount+=20;
                       }else{
                           total_amount+=40;
                       }
                   }
                   Intent i = new Intent(TicketBookingActivity.this,PaymentActivity.class);
                   i.putExtra("amount",total_amount);
                   startActivity(i);
               }else {
                   Toast.makeText(TicketBookingActivity.this, "Please add visitors", Toast.LENGTH_SHORT).show();
               }
